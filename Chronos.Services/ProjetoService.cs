...
namespace Chronos.Services
{
    public class ProjetoService : BaseService, IProjetoService
    {
        ...
        )
        {
            ...
            {
                await _logService.LogAsync(nameof(ProjetoService), nameof(AdicionarColaboradores), projetoId);
        ...
        public async Task<MensagemResponse> CadastrarAsync(ProjetoRequest request)
        {
            ...
            await _logService.LogAsync(nameof(ProjetoService), nameof(CadastrarAsync), 0);
